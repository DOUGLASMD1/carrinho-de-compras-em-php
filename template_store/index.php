				   			...
				   			<div class="col-md-6 col-md-offset-3 col-md-pull-2 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner">
				   					<div class="desc"><br>
					   					...
					   					<p><a href="#" class="btn btn-primary">Confira a coleção</a></p>
					   					</div>
				   				</div>
				   			</div>
				   		</div>
							...
							<div class="text-salebox">
								<div class="text-lefts">
									<div class="sale-box">
										...
										<h2 class="text-sale">DESCONTO</h2>
									</div>
								</div>
								<div class="text-rights">
									<h3 class="title">Quantidade limitada!</h3>
									<p>Separe já quantas peças quiser.</p>
									<p><a href="shop.html" class="btn btn-primary">Comprar agora</a> 
								</div>
							</div>
						</div>
					</div>
						...
						<div class="owl-carousel2">
							<div class="item">
								<div class="testimony text-center">
									...
									<span class="user">Luiza</span>
									<small>Corumbá, MS</small>
									<blockquote>
										<p>"Pude renovar meu guarda roupa".</p>
									</blockquote>
								</div>
							</div>
							<div class="item">
								<div class="testimony text-center">
									...
									<span class="user">Jenifer</span>
									<small>Corumbá, MS</small>
									<blockquote>
										<p>"Ótimas roupas para praticar esportes".</p>
									</blockquote>
								</div>
							</div>
						</div>
